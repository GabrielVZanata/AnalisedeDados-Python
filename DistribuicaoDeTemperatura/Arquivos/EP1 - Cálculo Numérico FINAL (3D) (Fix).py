...
Ui=np.zeros(N+1,dtype=float)                    #Vetor para valores iniciais ao longo da barra (para análise de dados)
Uf=np.zeros(N+1,dtype=float)                    #Vetor para valores finais ao longo da barra (para análise de dados)
...
print(U)
print("Temperaturas iniciais: ",Ui)
print("Temperaturas finais: ",Uf)
